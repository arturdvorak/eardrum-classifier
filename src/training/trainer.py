...
def train_all_strategies():
    ...
    This function:
    1. Loads the dataset
    2. Trains each strategy with learning rate tuning
    3. Saves checkpoints and logs results
    ...
    print(f"Dataset loaded successfully!")x
    ...
    for i, strategy in enumerate(strategies, 1):
        ...
        # Log checkpoint and model to MLflow
